...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { course_id: @professor.course_id, department: @professor.department, email: @professor.email, firstname: @professor.firstname, lastname: @professor.lastname, location: @professor.location, password: @professor.password }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { course_id: @professor.course_id, department: @professor.department, email: @professor.email, firstname: @professor.firstname, lastname: @professor.lastname, location: @professor.location, password: @professor.password }
    assert_redirected_to professor_path(assigns(:professor))
  end
